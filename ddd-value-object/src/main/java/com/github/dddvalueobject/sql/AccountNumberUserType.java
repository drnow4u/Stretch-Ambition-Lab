...
public class AccountNumberUserType implements UserType {
    ...
    public Object deepCopy(final Object o) {
        return o == null ? null : new AccountNumber(((AccountNumber) o).value());
    }
    ...
    @Override
    public Class<AccountNumber> returnedClass() {
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index, SharedSessionContractImplementor session) throws SQLException {
        if (value == null) {
            ...
            st.setString(index, ((AccountNumber) value).value());
        }
    }
